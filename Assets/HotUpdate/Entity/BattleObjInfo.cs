...
namespace HotUpdate.Entity
{
    public class BattleObjInfo
    {
        ...
        public Vector2 Up => Pos + new Vector2(0, -1);
        public Vector2 Down => Pos + new Vector2(0, 1);
        public Vector2 Left => Pos + new Vector2(-1, 0);
        public Vector2 Right => Pos + new Vector2(1, 0);
